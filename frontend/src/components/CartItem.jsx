    ...
    return (
        <div className='rounded-lg border p-4 shadow-xl border-gray-700/80 bg-gray-800/80 md:p-6 relative'>
            <div className='space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0'>
                ...
                <div className='w-full min-w-0 flex-1 space-y-2 md:order-2 md:max-w-md pr-12'> 
                ...
                <div className='flex w-full items-center justify-between md:order-3 md:w-auto'>
                    ...
                    <div className="text-end md:w-32">
                        <p className="text-xl font-extrabold text-emerald-400">${(item.price * item.quantity).toFixed(2)}</p>
                    </div>
                </div>
            </div>
        </div>
